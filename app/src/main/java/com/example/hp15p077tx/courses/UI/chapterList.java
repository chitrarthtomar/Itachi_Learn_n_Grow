...
public class chapterList extends AppCompatActivity implements content_Adapter.ItemClickCallback{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listData = (ArrayList) content_of_topic.getListData(topic);

        recyclerView = (RecyclerView)findViewById(R.id.chapter_recycle);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));

        contentAdapter = new content_Adapter(content_of_topic.getListData(topic),this);
